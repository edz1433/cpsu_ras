                            ...
                            <div class="form-row">
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="LastName" value="{{ $current_route == 'uEdit' ? $uEdit->lname : '' }}" oninput="this.value = this.value.toUpperCase()" placeholder="Enter Last Name" class="form-control" autocomplete="off">
                                    </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="FirstName" value="{{ $current_route == 'uEdit' ? $uEdit->fname : '' }}" oninput="this.value = this.value.toUpperCase()" placeholder="Enter First Name" class="form-control" autocomplete="off">
                                    </div>    
                            ...
                            <div class="form-row">
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="MiddleName" value="{{ $current_route == 'uEdit' ? $uEdit->mname : '' }}" oninput="this.value = this.value.toUpperCase()" placeholder="Enter Middle Name" class="form-control" autocomplete="off">
                                    </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="Username" value="{{ $current_route == 'uEdit' ? $uEdit->username : '' }}" placeholder="Enter Username" class="form-control" autocomplete="off">
                                    </div>    
                            ...
                            <div class="form-row">
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="password" name="Password" value="{{ $current_route == 'uEdit' ? "******" : '' }}" placeholder="Enter Password" class="form-control" autocomplete="off">
                                    </div>    
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-control select_camp" name="Role">
                                            ...
                                            <option value="Records Officer" selected>Records Officer</option>
                                        </select>
                                    </div>
