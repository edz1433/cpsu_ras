...
<head>
    ...
    <title>CPSU RAS {{isset($title)?'| '.$title:''}}</title>
        ...
        <nav class="main-header navbar navbar-expand-md navbar-light bg-greenn">
            <div class="container-fluid">
                <a href="" class="mt-2">
                    ...
                    <span class="brand-text text-light text-bold"> Records Archive System</span>
                </a>
                ...
                <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">             
                    <li class="nav-item">
                        <a class="nav-link" data-widget="control-sidebar" data-slide="true" href="#" role="button">
                            <i class="fas fa-user"></i>&nbsp;&nbsp;Signed In: {{auth()->user()->fname}} {{auth()->user()->lname}}
                        </a>
                    </li>
                </ul>
            </div>
