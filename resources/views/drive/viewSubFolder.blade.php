                                            ...
                                            <div class="file-options">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="fileOptions">
                                                        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#editFilerModal" onclick="editFile({{ $doc->docid }}, '{{ pathinfo($doc->file, PATHINFO_FILENAME) }}')">
                                                            <i class="fas fa-edit"></i> Rename
                                                        </a>
                                                        <a class="dropdown-item" href="{{ url($folder->folder_path.'/'.$doc->file) }}" target="_blank">
                                                            <i class="fas fa-eye"></i> View
                                                        </a>
                                                        <a class="dropdown-item" href="#"  onclick="deleteFile({{ $doc->docid }})">
